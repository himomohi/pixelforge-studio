...
export function validateProject(p:unknown): p is PixelProject {
  ...
  if(!Number.isInteger(x.width)||x.width<1||x.width>512||!Number.isInteger(x.height)||x.height<1||x.height>512)return false;
